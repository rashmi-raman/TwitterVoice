...
if q =='true':
	...
	decoder = ps.Decoder(hmm=am,
			     jsgf='/proj/speech/users/cs4706/asrhw/rr2779/conf_gram.jsgf',
	...
	confirmationList = ['YEAH','YES', 'YEP', 'YUP','OK','RIGHT','CORRECT','WHAT I SAID','ALRIGHT','NO','NOPE','WRONG','INCORRECT','NOT WHAT I SAID','EXIT','QUIT','HELP']
